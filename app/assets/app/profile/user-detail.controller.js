...
userDetailCtrl.$inject = ['$scope', '$stateParams', '$state', '$log', 'UserService', 'AnalyticsService', 'PointsService', 'CampaignService'];

function userDetailCtrl($scope, $stateParams, $state, $log, UserService, AnalyticsService, PointsService, CampaignService) {
  var vm = this;
